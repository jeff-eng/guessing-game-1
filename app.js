...
function askQuestion() {
  var questionArray = [['Is my first name Frazier?', 'y', 'Good job ' + userName + '!', 'You suck ' + userName + '!', 'firstAnswer'], ['Is my favorite color blue?', 'n', 'Good job ' + userName + '! My favorite color is green.', 'Wrong! My favorite color is green. Remember that ' + userName, 'secondAnswer'],['Was I born in Washington?','n', 'Good job ' + userName + '! I was born in New York.', 'Wrong! I was born in New York. Remember that ' + userName, 'thirdAnswer']];
  for (i = 0; i < questionArray.length; i++) {
    var res = document.getElementById(questionArray[i][4]);
    ...
    if (answer === questionArray[i][1]) {
      res.textContent = questionArray[i][2];
      // test.innerHTML ='<img src="http://www.toyhalloffame.org/sites/www.toyhalloffame.org/files/toys/square/rubber-duck_0.jpg"/>';
      res.className = 'correct';
      counter++;
    } else {
      res.textContent = questionArray[i][3];
...
// if (ans1 === "y"){
//   res1.textContent = ("Good job " + userName + "!");
//   counter++;
// } else {
